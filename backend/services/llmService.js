...
function buildFallbackAnalysis({ primaryType, secondaryType, traits, sourceTitles }) {
...
function buildPrompt({ primaryType, secondaryType, traits, dimensions, sourceTitles }) {
  return `
